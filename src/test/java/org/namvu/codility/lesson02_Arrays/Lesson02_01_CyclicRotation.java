package org.namvu.codility.lesson02_Arrays;

/**
 * [EASY] CyclicRotation: Rotate an array to the right by a given number of
 * steps.
 *
...
class Lesson02_01_CyclicRotation {
	 ...
	 * @param K
	 * @return
	 * @see https://app.codility.com/demo/results/trainingHC2KTQ-73C/
	 */
