...
class L10_03_Flags_Tests {
	...
	public void test1(int[] input, int output) {
		Assertions.assertEquals(output, new L10_03_Flags1().solution(input));
	}

	@ParameterizedTest
	@MethodSource(value = "createTestData")
	public void test2(int[] input, int output) {
		Assertions.assertEquals(output, new L10_03_Flags2().solution(input));
	}
